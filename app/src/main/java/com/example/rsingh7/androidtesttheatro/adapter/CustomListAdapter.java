package com.example.rsingh7.androidtesttheatro.adapter;
...
import com.example.rsingh7.androidtesttheatro.R;
...
public class CustomListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.listrow1, null);
